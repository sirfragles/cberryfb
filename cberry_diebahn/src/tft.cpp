...
This file controlls the communications between the Raspberry Pi and the TFT. 
The file initialized also the GPIO Pins of the Raspberry Pi.
...
// ----------------------------------------------------------
void TFT::SPI_data_out ( uint16_t data )
{
...
// ----------------------------------------------------------
void TFT::RegWrite( uint16_t reg )
{
  bcm2835_gpio_write( RAIO_RS, HIGH );
...
// write byte to tft
// ----------------------------------------------------------
void TFT::DataWrite( uint16_t data )
{
...
// ----------------------------------------------------------
void TFT::DataMultiWrite( uint16_t *data, uint32_t count )
{
